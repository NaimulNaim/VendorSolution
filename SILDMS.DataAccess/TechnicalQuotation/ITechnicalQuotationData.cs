...
namespace SILDMS.DataAccess.TechnicalQuotation
{
    public interface ITechnicalQuotationData
    {
        ...
        List<Quotation> submitquotationData(string Userid,string invId, string biddingItemVendorID, string invitationNumber,   out string errorNumber);
        int submittechnicalquotationData(string UserId,List<Model.VendorSelectionModule.TechnicalQuotation> technicalQuotationlist, List<MaterialInvitation> materialInvitationlist, Quotation quotation, out string errorNumber);
