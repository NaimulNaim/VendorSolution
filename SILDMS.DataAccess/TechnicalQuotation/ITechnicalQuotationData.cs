...
namespace SILDMS.DataAccess.TechnicalQuotation
{
    public interface ITechnicalQuotationData
    {
        ...
        List<Quotation> submitquotationData(string Userid,string invId, string biddingItemVendorID, string invitationNumber, string MaterialCode,string MaterialName,  out string errorNumber);
